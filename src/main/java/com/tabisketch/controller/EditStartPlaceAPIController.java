...
@RestController
@RequestMapping("/api/edit/start-place")
public class EditStartPlaceAPIController {
    private final ICreateStartPlaceService createStartPlaceService;

    public EditStartPlaceAPIController(final ICreateStartPlaceService createStartPlaceService) {
